...
public class BiologyFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            root_view = inflater.inflate(R.layout.fragment_biology, container, false);
    ...
    private List<Category> filterAcademicCategories(List<Category> categories) {
        List<Category> academic = new ArrayList<>();
    ...
    private void displayApiResult(final List<Category> categories) {
        ...
        List<Category> academicCategories = filterAcademicCategories(categories);

        adapterCategory.setListData(academicCategories);
        swipeProgress(false);

        if (academicCategories.size() == 0) {
            showNoItemView(true);
        }
    }
